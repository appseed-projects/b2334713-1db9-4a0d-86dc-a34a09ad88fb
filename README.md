...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-17 15:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b2334713-1db9-4a0d-86dc-a34a09ad88fb.git
$ cd b2334713-1db9-4a0d-86dc-a34a09ad88fb
```
